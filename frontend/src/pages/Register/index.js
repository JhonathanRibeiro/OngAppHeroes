        ...
        <div className="register-container">
            <div className="content">
                ...
                <form onSubmit={handleRegister}>
                    <input id="name" name="ong name" data-cy="name" placeholder="Nome da ONG"
                        value={name}
                        onChange={e => setName(e.target.value)} />
                    <input id="email" name="e-mail" type="email" data-cy="email" placeholder="Email"
                        value={email}
                        onChange={e => setEmail(e.target.value)} />
                    <input id="whats" name="whatsapp" data-cy="whatsapp" placeholder="Whatsapp"
                        value={whatsapp}
                        onChange={e => setWhatsapp(e.target.value)} />

                    <div className="input-group">
                        <input id="city" data-cy="cidade" placeholder="Cidade"
                            value={city}
